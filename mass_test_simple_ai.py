...
parser.add_argument("--dir", type=str, default="/u/05/aznarr1/unix/IdeaProjects/rl-pong-project/", help="Directory with agents.")
parser.add_argument("--render", "-r", action="store_true", default='False', help="Render the competition.")
parser.add_argument("--games", "-g", type=int, default=200, help="Number of games.")
parser.add_argument("--max_proc", "-p", type=int, default=8, help="Max number of processes.")
...
def run_test(agent_dir, games, render):
    ...
    testbench = PongTestbench(render=False, silent=False)
